...
def _single_simulation(
    ...
    # fname = f'{datetime.now().timestamp()}'
    # p_trajectories = Path(f'trajectories/{fname}.pkl')
    # p_np_arrays = Path(f'np_arrays/{fname}.npy')
    # p_to_arrays = Path(f'to_arrays/{fname}.npy')

    # with open(p_trajectories, 'wb') as f:
        # pickle.dump(trajectories, f)

    # np.save(p_to_arrays, trajectories.to_array())
